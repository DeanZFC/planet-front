<template>
  <el-container class="layout-cont">
    <el-container
      :class="[isSlider ? 'openside' : 'hideside', isMobile ? 'mobile' : '']"
    >
      <el-row :class="[isShadowBg ? 'shadowBg' : '']" @click="changeShadow()" />
      <el-aside class="main-cont main-left dp-aside">
        <div class="tilte" :style="{ background: backgroundColor }">
          <img alt class="logoimg" :src="$ADMIN.appLogo" />
          <div v-if="isSlider" class="tit-text" :style="{ color: textColor }">
            {{ $ADMIN.appName }}
          </div>
        </div>
        <Aside class="aside" />
                  ...
                  <el-row class="pd-0">
                    ...
                    >
                      <div class="menu-total" @click="totalCollapse">
                        <div
                          v-if="isCollapse"
                          class="dpIcon dpIcon-arrow-double-right"
                        />
                        <div v-else class="dpIcon dpIcon-arrow-double-left" />
                      </div>
                    </el-col>
                    <el-col
                      :xs="10"
...
import Operation from "@/view/layout/operation/index.vue";
...
onMounted(() => {
  ...
  userStore.loadingInstance && userStore.loadingInstance.close();
});
...
const totalCollapse = () => {
  ...
  isSlider.value = !isCollapse.value;
